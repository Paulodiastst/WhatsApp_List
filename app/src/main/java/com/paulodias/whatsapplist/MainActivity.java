package com.paulodias.whatsapplist;
...
import com.paulodias.whatsapplist.Adapter.AdapterUsuario;
import com.paulodias.whatsapplist.Model.Usuario;
import com.paulodias.whatsapplist.RecyclerItemClickListener.RecyclerItemClickListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void Usuarios(){
        ...
        Usuario usuario4 = new Usuario(R.drawable.usuario2, "Bianca", "Eu estou bem e você?");
        usuarioList.add(usuario4);

        Usuario usuario5 = new Usuario(R.drawable.usuario1, "João da Silva", "Oi");
        usuarioList.add(usuario5);

        Usuario usuario6 = new Usuario(R.drawable.usuario2, "Maria Clara", "Vamos ao shopping depois dp almoço?");
